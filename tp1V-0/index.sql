...
-- Concede todos los permisos en la base de datos verduleria al usuario root con contraseña vacía ('') y localhost.
GRANT ALL PRIVILEGES ON verduleria.* TO 'root'@'localhost' IDENTIFIED BY '' WITH GRANT OPTION;
