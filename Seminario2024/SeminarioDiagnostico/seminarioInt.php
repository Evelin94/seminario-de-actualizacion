...
$username = "root"; // Cambia a tu nombre de usuario de MySQL/MariaDB
$password = "123456789"; // Cambia a tu contraseña de MySQL/MariaDB
$database = "MySQL"; // Cambia al nombre de tu base de datos
